...
function User9_1(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User9_1', b_t9_1Data);
          ...
          console.error('Error adding b_t9_1:', error);
      }
  };

  const [b_t9_1, setb_t9_1] = useState<b_t9_1Data[]>([]);

  useEffect(() => {
    axios.get<b_t9_1Data[]>('http://localhost:8002/User9_1')
      .then(res => setb_t9_1(res.data))
