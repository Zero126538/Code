...
function User10_6(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User10_6', b_t10_6Data);
          ...
          console.error('Error adding b_t10_6:', error);
      }
  };

  const [b_t10_6, setb_t10_6] = useState<b_t10_6Data[]>([]);

  useEffect(() => {
    axios.get<b_t10_6Data[]>('http://localhost:8002/User10_6')
      .then(res => setb_t10_6(res.data))
