...
function User6_2(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User6_2', b_t6_2Data);
          ...
          console.error('Error adding b_t6_2:', error);
      }
  };

  const [b_t6_2, setb_t6_2] = useState<b_t6_2Data[]>([]);

  useEffect(() => {
    axios.get<b_t6_2Data[]>('http://localhost:8002/User6_2')
      .then(res => setb_t6_2(res.data))
