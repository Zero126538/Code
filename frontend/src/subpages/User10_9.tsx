...
function User10_9(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User10_9', b_t10_9Data);
          ...
          console.error('Error adding b_t10_9:', error);
      }
  };

  const [b_t10_9, setb_t10_9] = useState<b_t10_9Data[]>([]);

  useEffect(() => {
    axios.get<b_t10_9Data[]>('http://localhost:8002/User10_9')
      .then(res => setb_t10_9(res.data))
