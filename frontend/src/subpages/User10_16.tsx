...
function User10_16(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      const b_t10_16Data: b_t10_16Data = {
          start_date,
          end_date,
          season,
          book_number,
      ...
      try {
          const response = await axios.post('http://localhost:8002/User10_16', b_t10_16Data);
          ...
          console.error('Error adding b_t10_16:', error);
      }
  };

  const [b_t10_16, setb_t10_16] = useState<b_t10_16Data[]>([]);

  useEffect(() => {
    axios.get<b_t10_16Data[]>('http://localhost:8002/User10_16')
      .then(res => setb_t10_16(res.data))
