...
function User10_11(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      const b_t10_11Data: b_t10_11Data = {
          start_date,
          end_date,
          season,
          book_number,
      ...
      try {
          const response = await axios.post('http://localhost:8002/User10_11', b_t10_11Data);
          ...
          console.error('Error adding b_t10_11:', error);
      }
  };

  const [b_t10_11, setb_t10_11] = useState<b_t10_11Data[]>([]);

  useEffect(() => {
    axios.get<b_t10_11Data[]>('http://localhost:8002/User10_11')
      .then(res => setb_t10_11(res.data))
