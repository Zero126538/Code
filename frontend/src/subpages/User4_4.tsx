...
function User4_4(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User4_4', b_t4_4Data);
          ...
          console.error('Error adding b_t4_4:', error);
      }
  };

  const [b_t4_4, setb_t4_4] = useState<b_t4_4Data[]>([]);

  useEffect(() => {
    axios.get<b_t4_4Data[]>('http://localhost:8002/User4_4')
      .then(res => setb_t4_4(res.data))
