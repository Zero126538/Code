...
function User3_1(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User3_1', b_t3_1Data);
          ...
          console.error('Error adding b_t3_1:', error);
      }
  };

  const [b_t3_1, setb_t3_1] = useState<b_t3_1Data[]>([]);

  useEffect(() => {
    axios.get<b_t3_1Data[]>('http://localhost:8002/User3_1')
      .then(res => setb_t3_1(res.data))
