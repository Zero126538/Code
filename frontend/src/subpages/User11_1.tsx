...
function User11_1(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User11_1', b_t11_1Data);
          ...
          console.error('Error adding b_t11_1:', error);
      }
  };

  const [b_t11_1, setb_t11_1] = useState<b_t11_1Data[]>([]);

  useEffect(() => {
    axios.get<b_t11_1Data[]>('http://localhost:8002/User11_1')
      .then(res => setb_t11_1(res.data))
