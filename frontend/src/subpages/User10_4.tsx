...
function User10_4(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User10_4', b_t10_4Data);
          ...
          console.error('Error adding b_t10_4:', error);
      }
  };

  const [b_t10_4, setb_t10_4] = useState<b_t10_4Data[]>([]);

  useEffect(() => {
    axios.get<b_t10_4Data[]>('http://localhost:8002/User10_4')
      .then(res => setb_t10_4(res.data))
