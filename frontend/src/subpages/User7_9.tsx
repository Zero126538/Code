...
function User7_9(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User7_9', b_t7_9Data);
          ...
          console.error('Error adding b_t7_9:', error);
      }
  };

  const [b_t7_9, setb_t7_9] = useState<b_t7_9Data[]>([]);

  useEffect(() => {
    axios.get<b_t7_9Data[]>('http://localhost:8002/User7_9')
      .then(res => setb_t7_9(res.data))
