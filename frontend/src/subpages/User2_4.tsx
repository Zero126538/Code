...
function User2_4(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User2_4', b_t2_4Data);
          ...
          console.error('Error adding b_t2_4:', error);
      }
  };

  const [b_t2_4, setb_t2_4] = useState<b_t2_4Data[]>([]);

  useEffect(() => {
    axios.get<b_t2_4Data[]>('http://localhost:8002/User2_4')
      .then(res => setb_t2_4(res.data))
