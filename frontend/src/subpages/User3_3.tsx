...
function User3_3(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User3_3', b_t3_3Data);
          ...
          console.error('Error adding b_t3_3:', error);
      }
  };

  const [b_t3_3, setb_t3_3] = useState<b_t3_3Data[]>([]);

  useEffect(() => {
    axios.get<b_t3_3Data[]>('http://localhost:8002/User3_3')
      .then(res => setb_t3_3(res.data))
