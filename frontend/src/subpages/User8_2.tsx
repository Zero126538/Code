...
function User8_2(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User8_2', b_t8_2Data);
          ...
          console.error('Error adding b_t8_2:', error);
      }
  };

  const [b_t8_2, setb_t8_2] = useState<b_t8_2Data[]>([]);

  useEffect(() => {
    axios.get<b_t8_2Data[]>('http://localhost:8002/User8_2')
      .then(res => setb_t8_2(res.data))
