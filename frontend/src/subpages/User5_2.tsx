...
function User5_2(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User5_2', b_t5_2Data);
          ...
          console.error('Error adding b_t5_2:', error);
      }
  };

  const [b_t5_2, setb_t5_2] = useState<b_t5_2Data[]>([]);

  useEffect(() => {
    axios.get<b_t5_2Data[]>('http://localhost:8002/User5_2')
      .then(res => setb_t5_2(res.data))
