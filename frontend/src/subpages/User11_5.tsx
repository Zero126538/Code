...
function User11_5(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User11_5', b_t11_5Data);
          ...
          console.error('Error adding b_t11_5:', error);
      }
  };

  const [b_t11_5, setb_t11_5] = useState<b_t11_5Data[]>([]);

  useEffect(() => {
    axios.get<b_t11_5Data[]>('http://localhost:8002/User11_5')
      .then(res => setb_t11_5(res.data))
