...
function User7_3(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User7_3', b_t7_3Data);
          ...
          console.error('Error adding b_t7_3:', error);
      }
  };

  const [b_t7_3, setb_t7_3] = useState<b_t7_3Data[]>([]);

  useEffect(() => {
    axios.get<b_t7_3Data[]>('http://localhost:8002/User7_3')
      .then(res => setb_t7_3(res.data))
