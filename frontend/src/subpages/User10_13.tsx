...
function User10_13(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      const b_t10_13Data: b_t10_13Data = {
          start_date,
          end_date,
          season,
          book_number,
      ...
      try {
          const response = await axios.post('http://localhost:8002/User10_13', b_t10_13Data);
          ...
          console.error('Error adding b_t10_13:', error);
      }
  };

  const [b_t10_13, setb_t10_13] = useState<b_t10_13Data[]>([]);

  useEffect(() => {
    axios.get<b_t10_13Data[]>('http://localhost:8002/User10_13')
      .then(res => setb_t10_13(res.data))
