...
function User3_4(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User3_4', b_t3_4Data);
          ...
          console.error('Error adding b_t3_4:', error);
      }
  };

  const [b_t3_4, setb_t3_4] = useState<b_t3_4Data[]>([]);

  useEffect(() => {
    axios.get<b_t3_4Data[]>('http://localhost:8002/User3_4')
      .then(res => setb_t3_4(res.data))
