...
function User5_1(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User5_1', b_t5_1Data);
          ...
          console.error('Error adding b_t5_1:', error);
      }
  };

  const [b_t5_1, setb_t5_1] = useState<b_t5_1Data[]>([]);

  useEffect(() => {
    axios.get<b_t5_1Data[]>('http://localhost:8002/User5_1')
      .then(res => setb_t5_1(res.data))
