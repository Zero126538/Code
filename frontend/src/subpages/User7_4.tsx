...
function User7_4(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User7_4', b_t7_4Data);
          ...
          console.error('Error adding b_t7_4:', error);
      }
  };

  const [b_t7_4, setb_t7_4] = useState<b_t7_4Data[]>([]);

  useEffect(() => {
    axios.get<b_t7_4Data[]>('http://localhost:8002/User7_4')
      .then(res => setb_t7_4(res.data))
