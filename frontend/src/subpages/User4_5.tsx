...
function User4_5(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User4_5', b_t4_5Data);
          ...
          console.error('Error adding b_t4_5:', error);
      }
  };

  const [b_t4_5, setb_t4_5] = useState<b_t4_5Data[]>([]);

  useEffect(() => {
    axios.get<b_t4_5Data[]>('http://localhost:8002/User4_5')
      .then(res => setb_t4_5(res.data))
