...
function User10_17(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      const b_t10_17Data: b_t10_17Data = {
          start_date,
          end_date,
          season,
          book_number,
      ...
      try {
          const response = await axios.post('http://localhost:8002/User10_17', b_t10_17Data);
          ...
          console.error('Error adding b_t10_17:', error);
      }
  };

  const [b_t10_17, setb_t10_17] = useState<b_t10_17Data[]>([]);

  useEffect(() => {
    axios.get<b_t10_17Data[]>('http://localhost:8002/User10_17')
      .then(res => setb_t10_17(res.data))
