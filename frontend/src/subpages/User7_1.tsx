...
function User7_1(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User7_1', b_t7_1Data);
          ...
          console.error('Error adding b_t7_1:', error);
      }
  };

  const [b_t7_1, setb_t7_1] = useState<b_t7_1Data[]>([]);

  useEffect(() => {
    axios.get<b_t7_1Data[]>('http://localhost:8002/User7_1')
      .then(res => setb_t7_1(res.data))
