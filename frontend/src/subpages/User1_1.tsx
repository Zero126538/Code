...
function User1_1(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User1_1', b_t1_1Data);
          ...
          console.error('Error adding b_t1_1:', error);
      }
  };

  const [b_t1_1, setb_t1_1] = useState<b_t1_1Data[]>([]);

  useEffect(() => {
    axios.get<b_t1_1Data[]>('http://localhost:8002/User1_1')
      .then(res => setb_t1_1(res.data))
