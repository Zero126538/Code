...
function User10_3(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User10_3', b_t10_3Data);
          ...
          console.error('Error adding b_t10_3:', error);
      }
  };

  const [b_t10_3, setb_t10_3] = useState<b_t10_3Data[]>([]);

  useEffect(() => {
    axios.get<b_t10_3Data[]>('http://localhost:8002/User10_3')
      .then(res => setb_t10_3(res.data))
