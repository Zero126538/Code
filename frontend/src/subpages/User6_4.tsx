...
function User6_4(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User6_4', b_t6_4Data);
          ...
          console.error('Error adding b_t6_4:', error);
      }
  };

  const [b_t6_4, setb_t6_4] = useState<b_t6_4Data[]>([]);

  useEffect(() => {
    axios.get<b_t6_4Data[]>('http://localhost:8002/User6_4')
      .then(res => setb_t6_4(res.data))
