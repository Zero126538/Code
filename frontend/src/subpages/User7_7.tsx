...
function User7_7(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User7_7', b_t7_7Data);
          ...
          console.error('Error adding b_t7_7:', error);
      }
  };

  const [b_t7_7, setb_t7_7] = useState<b_t7_7Data[]>([]);

  useEffect(() => {
    axios.get<b_t7_7Data[]>('http://localhost:8002/User7_7')
      .then(res => setb_t7_7(res.data))
