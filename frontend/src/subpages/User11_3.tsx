...
function User11_3(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User11_3', b_t11_3Data);
          ...
          console.error('Error adding b_t11_3:', error);
      }
  };

  const [b_t11_3, setb_t11_3] = useState<b_t11_3Data[]>([]);

  useEffect(() => {
    axios.get<b_t11_3Data[]>('http://localhost:8002/User11_3')
      .then(res => setb_t11_3(res.data))
