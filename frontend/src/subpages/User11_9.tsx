...
function User11_9(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User11_9', b_t11_9Data);
          ...
          console.error('Error adding b_t11_9:', error);
      }
  };

  const [b_t11_9, setb_t11_9] = useState<b_t11_9Data[]>([]);

  useEffect(() => {
    axios.get<b_t11_9Data[]>('http://localhost:8002/User11_9')
      .then(res => setb_t11_9(res.data))
