...
function User10_2(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User10_2', b_t10_2Data);
          ...
          console.error('Error adding b_t10_2:', error);
      }
  };

  const [b_t10_2, setb_t10_2] = useState<b_t10_2Data[]>([]);

  useEffect(() => {
    axios.get<b_t10_2Data[]>('http://localhost:8002/User10_2')
      .then(res => setb_t10_2(res.data))
