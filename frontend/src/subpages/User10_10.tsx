...
function User10_10(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      const b_t10_10Data: b_t10_10Data = {
          start_date,
          end_date,
          season,
          book_number,
      ...
      try {
          const response = await axios.post('http://localhost:8002/User10_10', b_t10_10Data);
          ...
          console.error('Error adding b_t10_10:', error);
      }
  };

  const [b_t10_10, setb_t10_10] = useState<b_t10_10Data[]>([]);

  useEffect(() => {
    axios.get<b_t10_10Data[]>('http://localhost:8002/User10_10')
      .then(res => setb_t10_10(res.data))
