...
function User11_6(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User11_6', b_t11_6Data);
          ...
          console.error('Error adding b_t11_6:', error);
      }
  };

  const [b_t11_6, setb_t11_6] = useState<b_t11_6Data[]>([]);

  useEffect(() => {
    axios.get<b_t11_6Data[]>('http://localhost:8002/User11_6')
      .then(res => setb_t11_6(res.data))
