...
function User10_8(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User10_8', b_t10_8Data);
          ...
          console.error('Error adding b_t10_8:', error);
      }
  };

  const [b_t10_8, setb_t10_8] = useState<b_t10_8Data[]>([]);

  useEffect(() => {
    axios.get<b_t10_8Data[]>('http://localhost:8002/User10_8')
      .then(res => setb_t10_8(res.data))
