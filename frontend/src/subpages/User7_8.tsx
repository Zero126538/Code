...
function User7_8(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User7_8', b_t7_8Data);
          ...
          console.error('Error adding b_t7_8:', error);
      }
  };

  const [b_t7_8, setb_t7_8] = useState<b_t7_8Data[]>([]);

  useEffect(() => {
    axios.get<b_t7_8Data[]>('http://localhost:8002/User7_8')
      .then(res => setb_t7_8(res.data))
