...
function User8_3(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User8_3', b_t8_3Data);
          ...
          console.error('Error adding b_t8_3:', error);
      }
  };

  const [b_t8_3, setb_t8_3] = useState<b_t8_3Data[]>([]);

  useEffect(() => {
    axios.get<b_t8_3Data[]>('http://localhost:8002/User8_3')
      .then(res => setb_t8_3(res.data))
