...
function User11_4(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User11_4', b_t11_4Data);
          ...
          console.error('Error adding b_t11_4:', error);
      }
  };

  const [b_t11_4, setb_t11_4] = useState<b_t11_4Data[]>([]);

  useEffect(() => {
    axios.get<b_t11_4Data[]>('http://localhost:8002/User11_4')
      .then(res => setb_t11_4(res.data))
