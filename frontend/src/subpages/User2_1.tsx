...
function User2_1(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User2_1', b_t2_1Data);
          ...
          console.error('Error adding b_t2_1:', error);
      }
  };

  const [b_t2_1, setb_t2_1] = useState<b_t2_1Data[]>([]);

  useEffect(() => {
    axios.get<b_t2_1Data[]>('http://localhost:8002/User2_1')
      .then(res => setb_t2_1(res.data))
