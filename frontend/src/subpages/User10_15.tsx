...
function User10_15(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      const b_t10_15Data: b_t10_15Data = {
          start_date,
          end_date,
          season,
          book_number,
      ...
      try {
          const response = await axios.post('http://localhost:8002/User10_15', b_t10_15Data);
          ...
          console.error('Error adding b_t10_15:', error);
      }
  };

  const [b_t10_15, setb_t10_15] = useState<b_t10_15Data[]>([]);

  useEffect(() => {
    axios.get<b_t10_15Data[]>('http://localhost:8002/User10_15')
      .then(res => setb_t10_15(res.data))
