...
function User10_14(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      const b_t10_14Data: b_t10_14Data = {
          start_date,
          end_date,
          season,
          book_number,
      ...
      try {
          const response = await axios.post('http://localhost:8002/User10_14', b_t10_14Data);
          ...
          console.error('Error adding b_t10_14:', error);
      }
  };

  const [b_t10_14, setb_t10_14] = useState<b_t10_14Data[]>([]);

  useEffect(() => {
    axios.get<b_t10_14Data[]>('http://localhost:8002/User10_14')
      .then(res => setb_t10_14(res.data))
