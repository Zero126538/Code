...
function User4_2(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User4_2', b_t4_2Data);
          ...
          console.error('Error adding b_t4_2:', error);
      }
  };

  const [b_t4_2, setb_t4_2] = useState<b_t4_2Data[]>([]);

  useEffect(() => {
    axios.get<b_t4_2Data[]>('http://localhost:8002/User4_2')
      .then(res => setb_t4_2(res.data))
