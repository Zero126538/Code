...
function User9_3(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User9_3', b_t9_3Data);
          ...
          console.error('Error adding b_t9_3:', error);
      }
  };

  const [b_t9_3, setb_t9_3] = useState<b_t9_3Data[]>([]);

  useEffect(() => {
    axios.get<b_t9_3Data[]>('http://localhost:8002/User9_3')
      .then(res => setb_t9_3(res.data))
