...
function User1_2(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User1_2', b_t1_2Data);
          ...
          console.error('Error adding b_t1_2:', error);
      }
  };

  const [b_t1_2, setb_t1_2] = useState<b_t1_2Data[]>([]);

  useEffect(() => {
    axios.get<b_t1_2Data[]>('http://localhost:8002/User1_2')
      .then(res => setb_t1_2(res.data))
