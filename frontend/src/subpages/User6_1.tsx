...
function User6_1(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User6_1', b_t6_1Data);
          ...
          console.error('Error adding b_t6_1:', error);
      }
  };

  const [b_t6_1, setb_t6_1] = useState<b_t6_1Data[]>([]);

  useEffect(() => {
    axios.get<b_t6_1Data[]>('http://localhost:8002/User6_1')
      .then(res => setb_t6_1(res.data))
