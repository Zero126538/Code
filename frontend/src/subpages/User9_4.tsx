...
function User9_4(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User9_4', b_t9_4Data);
          ...
          console.error('Error adding b_t9_4:', error);
      }
  };

  const [b_t9_4, setb_t9_4] = useState<b_t9_4Data[]>([]);

  useEffect(() => {
    axios.get<b_t9_4Data[]>('http://localhost:8002/User9_4')
      .then(res => setb_t9_4(res.data))
