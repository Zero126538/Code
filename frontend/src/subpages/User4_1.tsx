...
function User4_1(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User4_1', b_t4_1Data);
          ...
          console.error('Error adding b_t4_1:', error);
      }
  };

  const [b_t4_1, setb_t4_1] = useState<b_t4_1Data[]>([]);

  useEffect(() => {
    axios.get<b_t4_1Data[]>('http://localhost:8002/User4_1')
      .then(res => setb_t4_1(res.data))
