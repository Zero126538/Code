...
function User3_2(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User3_2', b_t3_2Data);
          ...
          console.error('Error adding b_t3_2:', error);
      }
  };

  const [b_t3_2, setb_t3_2] = useState<b_t3_2Data[]>([]);

  useEffect(() => {
    axios.get<b_t3_2Data[]>('http://localhost:8002/User3_2')
      .then(res => setb_t3_2(res.data))
