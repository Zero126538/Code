...
function User6_3(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User6_3', b_t6_3Data);
          ...
          console.error('Error adding b_t6_3:', error);
      }
  };

  const [b_t6_3, setb_t6_3] = useState<b_t6_3Data[]>([]);

  useEffect(() => {
    axios.get<b_t6_3Data[]>('http://localhost:8002/User6_3')
      .then(res => setb_t6_3(res.data))
