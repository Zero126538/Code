...
function User10_1(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User10_1', b_t10_1Data);
          ...
          console.error('Error adding b_t10_1:', error);
      }
  };

  const [b_t10_1, setb_t10_1] = useState<b_t10_1Data[]>([]);

  useEffect(() => {
    axios.get<b_t10_1Data[]>('http://localhost:8002/User10_1')
      .then(res => setb_t10_1(res.data))
