...
function User11_7(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User11_7', b_t11_7Data);
          ...
          console.error('Error adding b_t11_7:', error);
      }
  };

  const [b_t11_7, setb_t11_7] = useState<b_t11_7Data[]>([]);

  useEffect(() => {
    axios.get<b_t11_7Data[]>('http://localhost:8002/User11_7')
      .then(res => setb_t11_7(res.data))
