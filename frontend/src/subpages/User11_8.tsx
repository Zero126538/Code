...
function User11_8(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User11_8', b_t11_8Data);
          ...
          console.error('Error adding b_t11_8:', error);
      }
  };

  const [b_t11_8, setb_t11_8] = useState<b_t11_8Data[]>([]);

  useEffect(() => {
    axios.get<b_t11_8Data[]>('http://localhost:8002/User11_8')
      .then(res => setb_t11_8(res.data))
