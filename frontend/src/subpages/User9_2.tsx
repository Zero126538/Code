...
function User9_2(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User9_2', b_t9_2Data);
          ...
          console.error('Error adding b_t9_2:', error);
      }
  };

  const [b_t9_2, setb_t9_2] = useState<b_t9_2Data[]>([]);

  useEffect(() => {
    axios.get<b_t9_2Data[]>('http://localhost:8002/User9_2')
      .then(res => setb_t9_2(res.data))
