...
function User5_3(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User5_3', b_t5_3Data);
          ...
          console.error('Error adding b_t5_3:', error);
      }
  };

  const [b_t5_3, setb_t5_3] = useState<b_t5_3Data[]>([]);

  useEffect(() => {
    axios.get<b_t5_3Data[]>('http://localhost:8002/User5_3')
      .then(res => setb_t5_3(res.data))
