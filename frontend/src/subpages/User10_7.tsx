...
function User10_7(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User10_7', b_t10_7Data);
          ...
          console.error('Error adding b_t10_7:', error);
      }
  };

  const [b_t10_7, setb_t10_7] = useState<b_t10_7Data[]>([]);

  useEffect(() => {
    axios.get<b_t10_7Data[]>('http://localhost:8002/User10_7')
      .then(res => setb_t10_7(res.data))
