...
function User10_5(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User10_5', b_t10_5Data);
          ...
          console.error('Error adding b_t10_5:', error);
      }
  };

  const [b_t10_5, setb_t10_5] = useState<b_t10_5Data[]>([]);

  useEffect(() => {
    axios.get<b_t10_5Data[]>('http://localhost:8002/User10_5')
      .then(res => setb_t10_5(res.data))
