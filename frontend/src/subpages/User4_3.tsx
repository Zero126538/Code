...
function User4_3(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User4_3', b_t4_3Data);
          ...
          console.error('Error adding b_t4_3:', error);
      }
  };

  const [b_t4_3, setb_t4_3] = useState<b_t4_3Data[]>([]);

  useEffect(() => {
    axios.get<b_t4_3Data[]>('http://localhost:8002/User4_3')
      .then(res => setb_t4_3(res.data))
