...
function User9_5(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User9_5', b_t9_5Data);
          ...
          console.error('Error adding b_t9_5:', error);
      }
  };

  const [b_t9_5, setb_t9_5] = useState<b_t9_5Data[]>([]);

  useEffect(() => {
    axios.get<b_t9_5Data[]>('http://localhost:8002/User9_5')
      .then(res => setb_t9_5(res.data))
