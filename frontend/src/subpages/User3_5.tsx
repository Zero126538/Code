...
function User3_5(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User3_5', b_t3_5Data);
          ...
          console.error('Error adding b_t3_5:', error);
      }
  };

  const [b_t3_5, setb_t3_5] = useState<b_t3_5Data[]>([]);

  useEffect(() => {
    axios.get<b_t3_5Data[]>('http://localhost:8002/User3_5')
      .then(res => setb_t3_5(res.data))
