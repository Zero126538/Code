...
function User7_6(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User7_6', b_t7_6Data);
          ...
          console.error('Error adding b_t7_6:', error);
      }
  };

  const [b_t7_6, setb_t7_6] = useState<b_t7_6Data[]>([]);

  useEffect(() => {
    axios.get<b_t7_6Data[]>('http://localhost:8002/User7_6')
      .then(res => setb_t7_6(res.data))
