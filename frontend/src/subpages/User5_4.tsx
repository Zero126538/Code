...
function User5_4(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User5_4', b_t5_4Data);
          ...
          console.error('Error adding b_t5_4:', error);
      }
  };

  const [b_t5_4, setb_t5_4] = useState<b_t5_4Data[]>([]);

  useEffect(() => {
    axios.get<b_t5_4Data[]>('http://localhost:8002/User5_4')
      .then(res => setb_t5_4(res.data))
