...
function User5_5(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User5_5', b_t5_5Data);
          ...
          console.error('Error adding b_t5_5:', error);
      }
  };

  const [b_t5_5, setb_t5_5] = useState<b_t5_5Data[]>([]);

  useEffect(() => {
    axios.get<b_t5_5Data[]>('http://localhost:8002/User5_5')
      .then(res => setb_t5_5(res.data))
