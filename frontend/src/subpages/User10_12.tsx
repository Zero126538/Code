...
function User10_12(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      const b_t10_12Data: b_t10_12Data = {
          start_date,
          end_date,
          season,
          book_number,
      ...
      try {
          const response = await axios.post('http://localhost:8002/User10_12', b_t10_12Data);
          ...
          console.error('Error adding b_t10_12:', error);
      }
  };

  const [b_t10_12, setb_t10_12] = useState<b_t10_12Data[]>([]);

  useEffect(() => {
    axios.get<b_t10_12Data[]>('http://localhost:8002/User10_12')
      .then(res => setb_t10_12(res.data))
