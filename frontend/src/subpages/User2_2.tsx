...
function User2_2(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User2_2', b_t2_2Data);
          ...
          console.error('Error adding b_t2_2:', error);
      }
  };

  const [b_t2_2, setb_t2_2] = useState<b_t2_2Data[]>([]);

  useEffect(() => {
    axios.get<b_t2_2Data[]>('http://localhost:8002/User2_2')
      .then(res => setb_t2_2(res.data))
