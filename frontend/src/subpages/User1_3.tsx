...
function User1_3(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User1_3', b_t1_3Data);
          ...
          console.error('Error adding b_t1_3:', error);
      }
  };

  const [b_t1_3, setb_t1_3] = useState<b_t1_3Data[]>([]);

  useEffect(() => {
    axios.get<b_t1_3Data[]>('http://localhost:8002/User1_3')
      .then(res => setb_t1_3(res.data))
