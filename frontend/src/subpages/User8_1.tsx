...
function User8_1(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User8_1', b_t8_1Data);
          ...
          console.error('Error adding b_t8_1:', error);
      }
  };

  const [b_t8_1, setb_t8_1] = useState<b_t8_1Data[]>([]);

  useEffect(() => {
    axios.get<b_t8_1Data[]>('http://localhost:8002/User8_1')
      .then(res => setb_t8_1(res.data))
