...
function User7_5(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User7_5', b_t7_5Data);
          ...
          console.error('Error adding b_t7_5:', error);
      }
  };

  const [b_t7_5, setb_t7_5] = useState<b_t7_5Data[]>([]);

  useEffect(() => {
    axios.get<b_t7_5Data[]>('http://localhost:8002/User7_5')
      .then(res => setb_t7_5(res.data))
