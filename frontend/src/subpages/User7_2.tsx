...
function User7_2(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User7_2', b_t7_2Data);
          ...
          console.error('Error adding b_t7_2:', error);
      }
  };

  const [b_t7_2, setb_t7_2] = useState<b_t7_2Data[]>([]);

  useEffect(() => {
    axios.get<b_t7_2Data[]>('http://localhost:8002/User7_2')
      .then(res => setb_t7_2(res.data))
