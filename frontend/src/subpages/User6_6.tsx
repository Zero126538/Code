...
function User6_6(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User6_6', b_t6_6Data);
          ...
          console.error('Error adding b_t6_6:', error);
      }
  };

  const [b_t6_6, setb_t6_6] = useState<b_t6_6Data[]>([]);

  useEffect(() => {
    axios.get<b_t6_6Data[]>('http://localhost:8002/User6_6')
      .then(res => setb_t6_6(res.data))
