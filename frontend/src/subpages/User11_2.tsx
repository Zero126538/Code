...
function User11_2(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User11_2', b_t11_2Data);
          ...
          console.error('Error adding b_t11_2:', error);
      }
  };

  const [b_t11_2, setb_t11_2] = useState<b_t11_2Data[]>([]);

  useEffect(() => {
    axios.get<b_t11_2Data[]>('http://localhost:8002/User11_2')
      .then(res => setb_t11_2(res.data))
