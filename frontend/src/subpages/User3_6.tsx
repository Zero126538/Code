...
function User3_6(): JSX.Element {
  ...
  const handleSubmit = async (event: FormEvent) => {
      ...
      try {
          const response = await axios.post('http://localhost:8002/User3_6', b_t3_6Data);
          ...
          console.error('Error adding b_t3_6:', error);
      }
  };

  const [b_t3_6, setb_t3_6] = useState<b_t3_6Data[]>([]);

  useEffect(() => {
    axios.get<b_t3_6Data[]>('http://localhost:8002/User3_6')
      .then(res => setb_t3_6(res.data))
